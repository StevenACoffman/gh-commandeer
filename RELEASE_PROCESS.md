...
```sh
gowheels pypi --package-name gh-commandeer --name gh-commandeer --repo StevenACoffman/gh-commandeer
```
...
gowheels pypi --name gh-commandeer --package-name gh-commandeer --repo StevenACoffman/gh-commandeer --upload
```
...
```sh
gowheels pypi --name gh-commandeer --package-name gh-commandeer --repo StevenACoffman/gh-commandeer --version v0.5.0 --upload
```
